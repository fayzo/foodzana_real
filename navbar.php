            ...
            <div class="header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 logo_section">
                            <div class="full">
                                <div class="center-desk">
                                    <div class="logo">
                                        <a href="<?php echo HOME ;?>"><img src="<?php echo BASE_URL_LINK ;?>images/foodzana.png" height="auto" width="200px" alt="#"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div>
                                <h2 style="display: inline-block;font-family: cursive;color: #111111; ">Fooodzana We Delivery Fast As We Can Our Priority Is Customer Satisfation</h2>
                                <a href="http://localhost/foodzana_real/">
                                <img src="http://localhost/foodzana_real/assets/images/foodzana_basket.png" alt="#" style="height: 50px;"></a>
